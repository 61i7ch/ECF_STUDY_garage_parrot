                    ...
                    <section class="row">
                        ...
                        <div class="col-12">
                                <div class="row justify-content-around">
                                        <article class="service1 col-12 col-md-3 d-flex flex-column align-items-center">
                                            <h2>MECANIQUE</h2>
                                            <!--<img class="service" src="img/MECA.jpg"/> -->
                                        </article>
                                        <article class="service2 col-12 col-md-3 d-flex flex-column align-items-center">
                                            <h2>CARROSSERIE</h2>
                                            <!--<img class="service" src="img/CARRO2.jpg"/>-->
                                        </article>
                                        <article class="service3 col-12 col-md-3 d-flex flex-column align-items-center">
                                            <h2>ENTRETIEN</h2>
